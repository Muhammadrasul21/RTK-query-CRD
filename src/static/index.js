...
export const likedCars = [
  ...
  { id: 4, name: "Mercedes-AMG GT", desc: "Hand-built V8, 523 HP, Luxurious Design" },
...
export const adminLinks = [
  ...
  { id: 2, path: "createcars", label: "CreateCars",icon: VscGitPullRequestCreate },
...
export const catalogInfo = [
  { id: 1, name: "Tesla Model S", price: "$89,990", image: "https://hips.hearstapps.com/hmg-prod/images/2025-tesla-model-s-1-672d42e172407.jpg?crop=0.465xw:0.466xh;0.285xw,0.361xh&resize=2048:*" },
  { id: 2, name: "BMW M3", price: "$72,800", image: "https://cdn.motor1.com/images/mgl/1ZQrxK/s3/2023-bmw-m3-cs-first-drive-review.jpg" },
  { id: 3, name: "Audi R8", price: "$158,600", image: "https://hips.hearstapps.com/hmg-prod/images/2023-audi-r8-gt-front-three-quarters-motion-3-1664827965.jpg?crop=0.684xw:0.577xh;0.0321xw,0.281xh&resize=2048:*" },
  { id: 4, name: "Mercedes-AMG GT", price: "$96,950", image: "https://vehicle-images.dealerinspire.com/371b-110012062/thumbnails/large/W1KRJ7JB8SF004347/ba0b4f6d356b00ea51bd487b8627d3ea.jpg" },
];