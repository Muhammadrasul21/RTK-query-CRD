...
const Shop = () => {
  return (
    <div className="p-6 max-w-3xl mx-auto bg-gray-900 text-white shadow-lg rounded-lg">
      ...
      <div className="p-4 rounded-md shadow-sm">
        ...
        <p className="mt-1">$79,990</p>
        <button className="mt-3 w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-700 transition">
          Buy Now
        </button>
      </div>
    </div>
